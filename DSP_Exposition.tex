...
which is the distribution function of $X$ truncated to $(a,b)$.  Thus we may sample from a truncated gamma distribution by sampling $u = U\big( F_X(a), F_X(b) \big)$ and then calculating $F_X^{-1}(u)$.
